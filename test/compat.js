...
tape('deterministic signatures', function (t) {
  ...
  var key = new Buffer('9718a1ff1c4ca79feac551c0c7212a65e4091278ec886b88be01ee4039682238', 'hex')
  var secretKey = new Buffer(
  ...
  var expectedSignatures = new Buffer(
